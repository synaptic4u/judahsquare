  ...
  <div class="container marketing pt-4">
    <div class="row featurette">
      <div class="col-sm-12 col-md-7">
        <h2 class="h2 featurette-heading fw-bolder">Seedlings<span class="text-muted"> - Ras Pouri</span></h2>
        <h5 class="h5 featurette-heading fw-bolder">Ras Pouri: +27 60 350 1176</h5>
        <p class="lead">
          Ras Pouri is currently running the nursery where he has a variety of vegetable seedlings available.
          <br>
          Place an order beforehand to avoid dissapointment.
          <br>
          Large orders may require a few weeks or a month lead time.
        </p>
        <h5 class="h5 featurette-heading fw-bolder">
          There is no official price list, so please call Pouri.
          <br>
          No WhatsApp / Email yet.
        </h5>  
        <ul>
          <li>Cabbage</li>
          <li>Spinach</li>
      ...
      <div class="col-sm-12 col-md-5 text-center">
        <img loading="lazy" src="./images/meet_us/pauly1.jpg" class="img featurette-image img-fluid mx-auto" style="position:relative; max-height:600px;width:auto;" alt="" srcset="">
      </div>
    </div>
