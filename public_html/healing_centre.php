...
<head>
  ...
  <!-- TITLE & ICON -->
  <title>HOJ Healing Centre</title>
...
<body class="doc_body">
  ...
  <div class="container marketing pt-4">
    <div class="row featurette">
      <div class="col-sm-12">
        <h2 class="h2 featurette-heading fw-bolder">Healing Centre <span class="text-muted"> - Sister Kerri</span></h2>
        <ul class="lead text-start">
          <li>
          It’s R350.00 per hour.
          </li>
        </ul>
        <p class="lead">
        Sister Kerri has years of experience in holistic healing.
        <br>
        She studied reflexology, reiki, shiatsu, various massage styles including Swedish, and aromatherapy.
        <br>
        She worked for years with a chiropractor assisting with massaging, realignments and been running her own practice for many seasons.
        <br>
        She has blended and refined these now and with years of practice
        <br>
        Incorporating these various disciplines into a seamless therapeutic hour to leave you relaxed and re-invigorated.
        <br><br>
        </p>
      </div>
