...
<body class="doc_body">
  ...
  <!-- House of Judah - Zionist Youth Feature -->
  <div class="container marketing pt-4">
    <div class="row featurette">
      <div class="col-sm-12 text-center">
        ...
        <iframe class="object-fit-scale w-100" height="480" src="https://www.youtube.com/embed/k7LKdRuhtrY" title="Zion Youth Feature" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
    </div>
  </div>
  <hr class="featurette-divider w-75 m-auto">

  <!-- House of Judah - Zion Youth Milestones -->
  <div class="container marketing pt-4">
    <div class="row featurette">
      <div class="col-sm-12 text-center">
        <h2 class="featurette-heading fw-bolder text-start">
        ...
        <iframe class="object-fit-scale w-100"  height="480"  src="https://www.youtube.com/embed/5SqLENATosM" title="Zion Youth Milestones" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
    </div>
  </div>
  <hr class="featurette-divider w-75 m-auto">

  <!-- House of Judah - Zionists at work 2 -->
  <div class="container marketing pt-4">
    <div class="row featurette">
      <div class="col-sm-12 text-center">
        <h2 class="featurette-heading fw-bolder text-start">
        ...
        <iframe class="object-fit-scale w-100"  height="480" src="https://www.youtube.com/embed/YC58q11hjH4" title="Zionists at work 2" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
    </div>
  </div>
  <hr class="featurette-divider w-75 m-auto">

  <!-- House of Judah - Zion Youth 2015 Saldhana Bay -->
  <div class="container marketing pt-4">
    <div class="row featurette">
      <div class="col-sm-12 text-center">
        <h2 class="featurette-heading fw-bolder text-start">
        ...
        <iframe class="object-fit-scale w-100" height="480" src="https://www.youtube.com/embed/g1Wo8DcvuZE" title="Zion Youth 2015 Saldhana Bay" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
    </div>
  </div>
  <hr class="featurette-divider w-75 m-auto">
