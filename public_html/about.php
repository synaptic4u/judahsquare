  ...
  <div class="container marketing pt-4">
    <div class="row featurette">
      <div class="col-sm-12 col-md-7">
        <h2 class="featurette-heading fw-bolder">About <span class="text-muted"></span></h2>
        <p class="lead">
          House of Judah Square was registered in 1993 and established in 1994.
          Judah Square serves as a umbrella for various branches of the organization.
          <br><br>
          Founded by Ras Maxi & Sister Nancy.
          They are supported by local elders of the community who each in their own right carry out key responsibilities.
          <br><br>
          The organization’s focus is upon being able to live out their beliefs in relationship equally and freely within community.
          Judah Square is a portion of land allocated to them where they can oversea their local development and allocation.
          <br><br>
          The Educare Creche is run by Sister Nanciy, currently acting Principal.
          Registered in 2008 they provide creche facilities to the broader community outside of Judah Square.
          Boasting 3 different classrooms and their own kitchen with secured facilities.
          <br><br>
          House of Judah are also affiliated with S.E.N.
          Together they partner to help preserve dedicated areas for nature conservation.
          <br><br>
          Additionally the Tourism is headed by Ras Zebi.
          He will share the history, struggles and victories of the community.
          Walking you through our heritage to show you who we are.
        </p>
      </div>
      <div class="col-sm-12 col-md-5 text-center">
        <img src="./images/meet_us/maxi_nancy.webp" class="img featurette-image img-fluid mx-auto" style="position:relative; max-height:600px;width:auto;" alt="" srcset="">
      </div>
    </div>
