...
<body class="doc_body">
  ...
  <div class="container marketing pt-4">
    <div class="row featurette">
      <div class="col-sm-12 ">
        <h2 class="featurette-heading fw-bolder">Initiatives <span class="text-muted"> - Ras Maxi</span></h2>
        <p class="lead">
          We have some initiatives that as a community we would like to dream, develop & introduce.
        </p>
        <ul class="lead">
          <li>
            Edibles made with love
          </li>
          <li>
            Delicatessen: Edibles like edibles and normal burgers, wraps and muffins. Simple coffee & teas too.
          </li>
          <li>
            Delicatessen delivers once daily to town.
          </li>
          <li>
            Seedling services. Vegetables and fruits.
          </li>
          <li>
            Fruit Trees 4 All Vision.
          </li>
          <li>
            Online shop for the sophisticated.
          </li>
          <li>
            Bonzais
          </li>
        ...
        <h4 class="featurett-heading fw-bolder">
          Marijuana Edibles:
        </h4>
        <p class="lead">
        Currently we will be looking at stocking some muffins, fudges and biscuits with some loving vitamin G.
        </p>
        <h4 class="featurette-heading fw-bolder">
          Delicatessen / Rise n Shine Restaurant:
        </h4>
        <p class="lead">
        We will be providing burgers, wraps, muffins etc to go or to sit with us, once we have created the space.
        <br>
        We will provide a link to the menu and orders and deliveries, but Knysna area only.
        <br>
        We do feature a restaurant that caters for tours, bookings mainly.
        <br>
        Please check out Rise n Shine Restaurant
        </p>
        <h4 class="featurette-heading fw-bolder">
          Seedlings 4 Vegetables & Fruits:
        </h4>
        <p class="lead">
        Ras Pauly spear heads this area. He already has the prototype for seeding fledged and read.
        <br>
        Some expansions to provide the platform and share to those interested. 
        <br>
        We will have a link to his page where you can view what is available and what is still to come from the nursery.
        <br><br>
        Online shop for the sophisticated… Stay tuned!
        </p>
      </div>
      <!-- <div class="col-sm-12 col-md-5 text-center">
        <img src="./images/maxi_nancy.webp" class="img featurette-image img-fluid mx-auto" style="position:relative; max-height:600px;width:auto;" alt="" srcset="">
      </div> -->
    </div>
