...
<body class="doc_body">
  ...
  <!-- House of Judah - Zebi being Iri -->
  <div class="container marketing pt-4">
    <div class="row featurette">
      <div class="col-sm-12 text-center">
        <h2 class="featurette-heading fw-bolder text-start">
          HOJ Storyteller Zebi - being Iri on FULLJOY
          <!-- <br> -->
          <!-- <span class="text-muted">New Years Eve Bash - 31 Dec 2023</span> -->
        </h2>
        <iframe class="object-fit-scale w-100" autoplay="true" height="480" src="https://www.youtube.com/embed/hVBpp4URw7g" title="Zebi Cool Clips" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
    </div>
  </div>
  ...
  <div class="container marketing pt-4">
    <div class="row featurette">
      <div class="col-sm-12 col-md-7">
        <h2 class="featurette-heading fw-bolder">Tourism - Story Teller<span class="text-muted"> - Ras Zebi</span></h2>
        <p class="lead">
          We have a a heart for you, to welcome you, to let you in.
        <br>
          That you may come within our community and let us share our song with you.
        <br>
          A song worthy to be sung of how we came and stood together, established ourselves, grew strong and still carry our flame!
        <br>
        </p>
        <h4 class="h4 featurette-heading fw-bolder">Ras Zebi Cell: +27 76 649 1034</h4>
        <h4 class="h4 featurette-heading fw-bolder">Tour costs:</h4>   
        <ul class="lead text-start">
          <li>
            Judah Square only @ ZAR 150.00 per group.
          </li>
          <li>
            Tour from Knysna through Khayalethu & Judah Square @ ZAR 250.00 per group.
          </li>
        </ul>
      </div>
      <div class="col-sm-12 col-md-5 text-center">
        <img src="./images/tourism/zebi_promote_main2.webp" class="img featurette-image img-fluid mx-auto" style="position:relative; max-height:600px;width:auto;" alt="" srcset="">
      </div>
    </div>
