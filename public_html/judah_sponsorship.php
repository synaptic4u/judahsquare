...
<head>
  ...
  <!-- TITLE & ICON -->
  <title>HOJ House of Judah Sponsorship</title>
...
<body class="doc_body">
  ...
  <div class="container marketing pt-4">  
    <div class="row featurette">
      <div class="col-sm-12 ">
        <h2 class="featurette-heading fw-bolder">Sponsorship<span class="text-muted"> - Ras Maxi</span></h2>
        <p class="lead">
        This will describe all the House of Judah initiatives that you will be able to contribute to.
        <br>
        We have lots of dreams for our Rastafari family…
        <br>
        There’s more…
        <br>
        We have dreams for our greater Khayalethu family…
        <br>
        We have dreams for our beautiful piece of the Garden Route…
        <br><br>
        Far more…
        <br>
        Our hopes & dreams are for Africa, We are all Africa!
        </p>
      </div>
